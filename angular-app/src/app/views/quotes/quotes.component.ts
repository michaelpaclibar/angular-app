...
export class QuotesComponent implements OnInit {
  ...
  ngOnInit() {
    this.quotes = [
      {quoteNumber: '123343.100000', clientCode: '312123', description: 'Quotation 1', status: 'Open'},
      ...
      {quoteNumber: '634223.100300', clientCode: '312123', description: 'Quotation 6', status: 'In Process'},
      ...
      {quoteNumber: '884545.100090', clientCode: '735744', description: 'Quotation 111', status: 'Denied'}
    ];
  }
